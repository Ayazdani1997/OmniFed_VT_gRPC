...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TENSORENTRY']._serialized_end=607
  _globals['_GRPCSERVER']._serialized_start=610
  _globals['_GRPCSERVER']._serialized_end=1043
