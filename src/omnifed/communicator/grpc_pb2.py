...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TENSORENTRY']._serialized_end=612
  _globals['_GRPCSERVER']._serialized_start=615
  _globals['_GRPCSERVER']._serialized_end=1048
